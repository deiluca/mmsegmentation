...
evaluation = dict(interval=1, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,     
                        outdir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg_incl_Julian_annotations/inference/split1/eval_imgs')    
log_config = dict(    
            interval=1,    
            hooks=[    
...
data = dict(    
        ...
        val=dict(    
            data_root=data_root,    
            img_dir='images/2d_ms_org_seg_run4_for_inference',    
            ann_dir='masks/for_inference_2d_ms_org_seg_run4_dummy_label'))   
work_dir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg_incl_Julian_annotations/inference/split1'
