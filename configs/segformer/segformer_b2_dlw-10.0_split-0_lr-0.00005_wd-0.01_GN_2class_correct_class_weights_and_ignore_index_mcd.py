...
evaluation = dict(interval=10, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,         
                        outdir='/home/ws/oc9627/mmseg_fork/work_dirs/try_to_include_mcd/eval_imgs')        
log_config = dict(        
            interval=10,        
            hooks=[        
...
data = dict(        
        ...
        test=dict(# new for checking inference
            ...
            img_dir='images/split0_validation',        
            ann_dir='masks/split0_validation'))        
work_dir='/home/ws/oc9627/mmseg_fork/work_dirs/try_to_include_mcd'