...
evaluation = dict(interval=10, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,     
                        outdir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg_incl_Julian_annotations/split_like_microbeseg/eval_imgs')    
log_config = dict(    
            interval=10,    
            hooks=[    
...
data = dict(    
        ...
        train=dict(    
            data_root=data_root,    
            img_dir='images/split_like_microbeseg_train',   
            ann_dir='masks/split_like_microbeseg_train'),    
        val=dict(    
            data_root=data_root,    
            img_dir='images/split_like_microbeseg_val',     
            ann_dir='masks/split_like_microbeseg_val'))    
work_dir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg_incl_Julian_annotations/split_like_microbeseg'