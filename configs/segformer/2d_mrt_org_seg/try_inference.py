...
evaluation = dict(interval=1, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,     
                        outdir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg/try_inference/eval_imgs')    
log_config = dict(    
            interval=1,    
            hooks=[    
...
data = dict(    
        ...
        val=dict(    
            data_root=data_root,    
            img_dir='images/for_inference_mrt_org',    
            ann_dir='masks/for_inference_mrt_org_dummy_label'))   
work_dir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg/try_inference'
