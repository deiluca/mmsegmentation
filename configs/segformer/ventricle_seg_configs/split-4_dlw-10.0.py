...
evaluation = dict(interval=10, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,         
                        outdir='/home/ws/oc9627/mmsegmentation/work_dirs/segformer_mit-b0_512x512_160k_IF/first_hp_tune/split-4_dlw-10.0/eval_imgs')        
log_config = dict(        
            interval=10,        
            hooks=[        
...
work_dir='/home/ws/oc9627/mmsegmentation/work_dirs/segformer_mit-b0_512x512_160k_IF/first_hp_tune/split-4_dlw-10.0'