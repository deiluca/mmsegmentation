...
evaluation = dict(interval=10, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True, outdir="/home/ws/oc9627/mmsegmentation/work_dirs/segformer_mit-b0_512x512_160k_IF/eval_imgs")
# evaluation = dict(interval=10, metric='mDice', by_epoch=True)
log_config = dict(
    interval=10,
    hooks=[
