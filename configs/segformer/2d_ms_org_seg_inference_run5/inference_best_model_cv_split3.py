...
evaluation = dict(interval=1, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,     
                        outdir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg_incl_Julian_annotations/inference_run5/split3/eval_imgs')    
log_config = dict(    
            interval=1,    
            hooks=[    
...
work_dir='/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg_incl_Julian_annotations/inference_run5/split3'
