...
outdir_root = '/home/ws/oc9627/mmseg_fork/work_dirs/2d_ms_org_seg'
...
for split in range(5):
    ...
    \nwork_dir='"+outdir+"'"
    with open(os.path.join("/home/ws/oc9627/mmsegmentation/configs/segformer/2d_ms_org_seg", f"{conf_id}.py"), "w") as text_file:
